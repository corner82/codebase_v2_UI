...
$('#tt_tree_menu').tree({
//url: 'https://proxy.codebase_v2.com/SlimProxyBoot.php?url=pkFillForAdminTree_leftnavigation&pk=' + $("#pk").val()+ '&role_id='+selectedData.selectedData.value+'&language_code='+$("#langCode").val()+'&menu_types_id='+menu_types_id,
method: 'get',
animate: true,
checkbox: true,
cascadeCheck: false,
                    ...
                    onItemClicked : function(target) {
                        ...
                        if(target.value>0){
                            ...
                            if(ddDataMenuTypes.selectedData.value>0) {
                                ...
                                $('#tt_tree_menu').tree({ 
                                    url: 'https://proxy.codebase_v2.com/SlimProxyBoot.php?url=pkFillForAdminTree_leftnavigation&pk=' + $("#pk").val()+ '&role_id='+target.value+'&language_code='+$("#langCode").val()+'&menu_types_id='+menu_types_id,
                                });
                            } else {
                                                ...
                                                <div id="loading-image-crud-popup" class="box box-primary">\n\
                                                    ...
                                                    <div class="hr-line-dashed"></div>\n\
                                                        ...
                                                        <div class="form-group">\n\
                                                            ...
                                                            <button id="insertMenuPopUp" class="btn btn-man-primary" type="submit" onclick="return insertMenuWrapper(event, '+nodeID+', \''+nodeName+'\');">\n\
