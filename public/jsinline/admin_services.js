            ...
            {field:'action',title:'Action',width:80,align:'center',
                formatter:function(value,row,index){
                    if(row.attributes.active == 0) {
                        var e = '<button style="padding : 2px 4px;" title="Pasif yap"  class="btn btn-man-primary" type="button" onclick="return activePassiveServicesWrapper(event, '+row.id+');"><i class="fa fa-minus-circle"></i></button>';
                    } else {
                                                 ...
                                                 <div id="loading-image-crud-popup" class="box box-primary">\n\
                                                     ...
                                                     <div class="hr-line-dashed"></div>\n\
                                                         ...
                                                         <div class="form-group">\n\
                                                             ...
                                                             <button id="insertMachPopUp" class="btn btn-man-primary" type="submit" onclick="return updateServiceWrapper(event, '+id+');">\n\
