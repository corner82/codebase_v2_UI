...
//            console.log('update' + $("#pk").val());
            $.ajax({
                url: 'https://proxy.codebase_v2.com/SlimProxyBoot.php',
//                url: 'http://proxy.miyaPerformans.com:9990/SlimProxyBoot.php',
                data: {
 ...
 * 
    $('#table_address_modal').bootstrapTable({
        url: "https://proxy.codebase_v2.com/SlimProxyBoot.php?url=9***************",
        method: 'GET',
...
$('#table_contacts_modal').bootstrapTable({
    url: "https://proxy.codebase_v2.com/SlimProxyBoot.php?url=**************",
    method: 'GET',
    locale: "'" + ($('#langCode').val() + '-' + $('#langCode').val().toUpperCase()) + "'",
    toggle: "table",
    width: "500",
