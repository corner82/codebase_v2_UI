            ...
            {field:'action',title:'Action',width:80,align:'center',
                formatter:function(value,row,index){
                    if(row.attributes.active == 0) {
                        var e = '<button style="padding : 2px 4px;" title="Pasif yap"  class="btn btn-man-primary" type="button" onclick="return activePassiveOperationsWrapper(event, '+row.id+');"><i class="fa fa-minus-circle"></i></button>';
                    } else {
...
$('#tt_tree_services').tree({
    url: 'https://proxy.codebase_v2.com/SlimProxyBoot.php?url=pkFillRestServicesOfPrivilegesTree_sysAclRrpRestservices&pk=' + $("#pk").val()+ '&language_code='+$("#langCode").val()+ '',
    method: 'get',
    animate: true,
    checkbox: false,
    cascadeCheck: false,
...
*/
$('#tt_tree_menu2').tree({  
    url: 'https://proxy.codebase_v2.com/SlimProxyBoot.php?url=pkFillResourceGroups_sysAclResources&pk=' + $("#pk").val()+ '&language_code='+$("#langCode").val(),
    method: 'get',
    animate: true,
    checkbox: false,
    cascadeCheck: false,
    ...
    onSelect: function(node) { 
        ...
        if(!self.tree('isLeaf', node.target)) {
            ...
            nonAttachedTreeLoadImage.loadImager('appendImage');
            $('#tt_tree_services').tree({
                url: 'https://proxy.codebase_v2.com/SlimProxyBoot.php?url=pkFillRestServicesOfPrivilegesTree_sysAclRrpRestservices&pk=' + $("#pk").val()+ '&language_code='+$("#langCode").val()+ '&role_id='+node.id+'&resource_id='+node.resource_id,
            });
        }
    },
         ...
         $('#dropdownAssignments').ddslick({
            ...
            onSelected: function(selectedData){
                if(selectedData.selectedData.value>0) {
                    /*$('#tt_tree_services').tree({
                        url: 'https://proxy.codebase_v2.com/SlimProxyBoot.php?url=pkFillRestServicesOfPrivilegesTree_sysAclRrpRestservices&pk=' + $("#pk").val()+ '&language_code='+$("#langCode").val()+ '&role_id='+selectedData.selectedData.value,
                    });*/
                }
            }   
        });   
                                                     ...
                                                     <div class="hr-line-dashed"></div>\n\
                                                        ...
                                                        <div class="form-group">\n\
                                                         ...
                                                         <div class="form-group">\n\
                                                             ...
                                                             <button id="insertMachPopUp" class="btn btn-man-primary" type="submit" onclick="return updateOperationWrapper(event, '+id+');">\n\
