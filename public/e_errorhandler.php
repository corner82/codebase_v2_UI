...
function handler($errno, $errstr, $errfile, $errline)
{
    ...
    if (DISPLAY_ERRORS) {
        ...
        $mail->setFrom('311corner82@gmail.com', 'Sender\'s name');
        $mail->addTo('ociran@gmail.com', 'Your Site Team');
        ...
        include __DIR__.'/../module/Admin/view/error/error/e_handler.phtml';
        die;
    }
}
